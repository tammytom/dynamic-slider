class CarouselModel {
    ...
    this.cards = [
      {
        ...
        details: {
          ...
          points: [
            "Multi-currency processing worldwide",
            "Optimized real-time FX rates",
      ...
      },
      {
        ...
        details: {
          title: "Branded Payee Portal",
          points: [
            "Self-service payment control",
  ...
  init() {
    ...
    if (this.state === "carousel" && window.innerWidth > 768) {
      requestAnimationFrame(() => {
        this.notify("openCarousel", {
          index: this.currentIndex,
          cards: this.cards,
          total: this.cards.length,
          restored: true,
